<%-- 
    Document   : update
    Created on : Mar 11, 2024, 10:43:58 PM
    Author     : datng
--%>
                ...
                <div style="display: flex">
                    ...
                    <div style="background-color: white;padding: 20px">
                        <form action="update" method="post" id="form">
                            <input style="display: none" type="text" value="${id}" name="id" required="">
                            <input style="display: none" type="text" value="${data.getMotorId()}" name="motorId" required="">
                        <input style="font-size: 17px;" type="text" value="${data.getNamerent()}" id="name" name="name" placeholder="Nhập họ tên của bạn" required=""><br>
                        <input style="font-size: 17px;" type="email" value="${data.getEmail()}" id="email" name="email" placeholder="Nhập email của bạn" required=""><br>
                        <input style="font-size: 17px;" type="tel" value="${data.getPhonenumber()}" id="phone" name="phone" placeholder="Nhập số điện thoại của bạn" pattern="[0-9]*" required=""><br>
                        ...
                        <input style="font-size: 17px;" value="${data.getRentdate()}" type="date" id="date" name="rentdate" required=""><br>
                        <div>
                            <img style="width: 500px; height: auto" src="${data.getUrl()}">
                        </div>
                        <div style="border-color: #CE7A58;background-color: #CE7A58;;margin-left: 135px;margin-top: 10px; border-radius: 7px; border: 1px #CE7A58 solid; height: 35px; width: 240px;cursor: pointer; display: flex; align-items: center; justify-content: center;" onclick="showAlertSubmit()">
                            <div style="color: #1E2F41; font-size: 21px; font-weight: 600; font-family: Arial;color: white;" >Thay đổi</div>
                        </div>
                        <script>
                            function showAlertSubmit() {
                                ...
                                if (name === "" || email === "" || phone === "" || rentdate === "") {
                                    ...
                                    Swal.fire({
                                        title: "Chúc mừng thay đổi xe thành công",
                                        icon: "success",
